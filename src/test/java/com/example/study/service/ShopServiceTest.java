...
class ShopServiceTest {
  ...
  private final Clock fixedClock =
      Clock.fixed(Instant.parse("2026-04-25T10:00:00Z"), ZoneId.of("Asia/Tokyo"));
  ...
  void getProduct_存在しない場合は例外を投げる() {
    ...
    assertThrows(RuntimeException.class, () -> shopService.getProduct(999));
  }
  ...
  void purchase_在庫不足の場合は例外を投げる() {
    ...
    RuntimeException ex = assertThrows(RuntimeException.class, () -> shopService.purchase(1, 5));
  ...
  void purchase_存在しない商品の場合は例外を投げる() {
    ...
    assertThrows(RuntimeException.class, () -> shopService.purchase(999, 1));
